Citizen.CreateThread(function()
	while true do
		...
		SetDiscordAppId(820948249057427456)

        -- Here you will have to put the image name for the "large" icon.
		SetDiscordRichPresenceAsset('wrplogo')
        
        -- (11-11-2018) New Natives:

        -- Here you can add hover text for the "large" icon.
       SetDiscordRichPresenceAssetText('West coast RP')
       
        -- Here you will have to put the image name for the "small" icon.
        SetDiscordRichPresenceAssetSmall('additionaldoc_10_0')

        -- Here you can add hover text for the "small" icon.
        SetDiscordRichPresenceAssetSmallText('Ve vývoji')
        ...
        SetDiscordRichPresenceAction(0, "🎩Připojit se🎩", "fivem://connect/87.237.54.31:30120")
        SetDiscordRichPresenceAction(1, "🎩Náš Discord🎩", "https://discord.gg/dHF97d5Fee")
